...
class AppLocalizations {
  static final Map<String, Map<AppLanguage, String>> _values = {
    ...
    'reading_badge_ai': {
      AppLanguage.korean: '🤖 에밀리 AI 해석',
      AppLanguage.english: '🤖 Emily AI Reading',
      AppLanguage.chinese: '🤖 艾米丽AI解读',
      AppLanguage.japanese: '🤖 エミリーAI鑑定',
      AppLanguage.vietnamese: '🤖 Emily AI giải bài',
    },
    'reading_badge_basic': {
      AppLanguage.korean: '📝 에밀리 기본 노트',
      AppLanguage.english: '📝 Emily Basic Notes',
      AppLanguage.chinese: '📝 艾米丽基础笔记',
      AppLanguage.japanese: '📝 エミリーノート',
      AppLanguage.vietnamese: '📝 Ghi chú cơ bản Emily',
    },
    'ai_fallback_notice': {
      AppLanguage.korean: '⚠️ AI 연결에 실패해 기본 노트로 대체했어요. 잠시 후 다시 시도해 주세요.',
      AppLanguage.english: '⚠️ AI connection failed — showing Basic Notes instead. Please try again shortly.',
      AppLanguage.chinese: '⚠️ AI连接失败，已改用基础笔记。请稍后再试。',
      AppLanguage.japanese: '⚠️ AI接続に失敗したため基本ノートを表示します。しばらくしてから再試行してください。',
      AppLanguage.vietnamese: '⚠️ Kết nối AI thất bại — hiển thị Ghi chú cơ bản. Vui lòng thử lại sau.',
    },
